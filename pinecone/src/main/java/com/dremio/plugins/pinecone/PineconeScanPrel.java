...
/** Physical plan node for a Pinecone index scan. */
public class PineconeScanPrel extends ScanPrelBase implements OldScanPrelBase {

    private final PineconeGroupScan groupScan;
    private final PineconeScanSpec scanSpec;

    public PineconeScanPrel(
            ...
            List<RelHint> hints, PineconeGroupScan groupScan, PineconeScanSpec scanSpec) {
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new PineconeScanPrel(getCluster(), traitSet, getTable(), getPluginId(),
    ...
    public ScanRelBase cloneWithProject(List<SchemaPath> columns) {
        return new PineconeScanPrel(getCluster(), getTraitSet(), getTable(), getPluginId(),
