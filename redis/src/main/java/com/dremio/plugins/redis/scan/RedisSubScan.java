...
public class RedisSubScan extends SubScanWithProjection {
  ...
  public RedisSubScan(
      ...
      @JsonProperty("scanSpec") RedisScanSpec            scanSpec) {
  ...
  @JsonProperty("scanSpec") public RedisScanSpec   getScanSpec()  { return scanSpec; }
  ...
  public PhysicalOperator getNewWithChildren(List<PhysicalOperator> children)
    ...
    return new RedisSubScan(getProps(), getFullSchema(), getReferencedTables(),
