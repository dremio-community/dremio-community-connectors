#!/usr/bin/env bash
# First-time install of the PagerDuty connector into a running Dremio container or local install.
set -euo pipefail

JAR="jars/dremio-pagerduty-connector-1.0.0.jar"
CONTAINER="${DREMIO_CONTAINER:-dremio-test}"
