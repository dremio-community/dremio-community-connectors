...
public class JiraRulesFactory extends StoragePluginTypeRulesFactory {
    ...
    public Set<RelOptRule> getRules(OptimizerRulesContext context,
        ...
        switch (phase) {
            case LOGICAL:  return ImmutableSet.of(JiraScanRule.INSTANCE);
            case PHYSICAL: return ImmutableSet.of(JiraScanPrule.INSTANCE);
