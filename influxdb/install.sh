#!/usr/bin/env bash
# ============================================================================
# Dremio InfluxDB Connector — Installer
#
...
PLUGIN_JAR_NAME="dremio-influxdb-connector-1.0.0.jar"
...
banner() {
  ...
  echo -e "${BOLD}${CYAN}   Dremio InfluxDB Connector Installer${RESET}"
  echo -e "${BOLD}${CYAN}════════════════════════════════════════════════════${RESET}"
  echo ""
}
...
echo ""
echo -e "  Next: open Dremio → ${BOLD}Add Source${RESET} → ${BOLD}InfluxDB${RESET}"
echo ""
echo -e "  Or create a source from the command line:"
echo -e "    ${CYAN}./add-influxdb-source.sh \\${RESET}"
echo -e "    ${CYAN}    --name influxdb_sensors \\${RESET}"
echo -e "    ${CYAN}    --host http://localhost:8181 \\${RESET}"
echo -e "    ${CYAN}    --database sensors \\${RESET}"
echo -e "    ${CYAN}    --token YOUR_INFLUXDB_TOKEN${RESET}"
echo ""
