...
public class InfluxDBRulesFactory extends StoragePluginTypeRulesFactory {
    ...
    public Set<RelOptRule> getRules(OptimizerRulesContext context,
        ...
        switch (phase) {
            case LOGICAL:
                return ImmutableSet.of(InfluxDBScanRule.INSTANCE);
            case PHYSICAL:
                return ImmutableSet.of(InfluxDBScanPrule.INSTANCE);
            default:
