#!/usr/bin/env bash
# ============================================================================
# Dremio Stripe Connector — Installer
#
...
banner() {
  ...
  echo -e "${BOLD}${CYAN}   Dremio Stripe Connector Installer${RESET}"
  echo -e "${BOLD}${CYAN}════════════════════════════════════════════════════${RESET}"
  echo ""
}
...
echo ""
echo -e "  Next: open Dremio → ${BOLD}Add Source${RESET} → ${BOLD}Stripe${RESET}"
echo ""
echo -e "  Or create a source from the command line:"
echo -e "    ${CYAN}./add-stripe-source.sh --name stripe --api-key sk_live_...${RESET}"
echo ""
