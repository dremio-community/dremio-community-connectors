...
/** Logical plan node for a Stripe table scan. */
public class StripeScanDrel extends ScanRelBase implements Rel {

    private final StripeScanSpec scanSpec;

    public StripeScanDrel(
            ...
            List<RelHint> hints, StripeScanSpec scanSpec) {
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new StripeScanDrel(getCluster(), traitSet, getTable(), getPluginId(),
    ...
    public ScanRelBase cloneWithProject(List<SchemaPath> columns) {
        return new StripeScanDrel(getCluster(), getTraitSet(), getTable(), getPluginId(),
