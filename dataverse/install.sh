#!/usr/bin/env bash
# ============================================================================
# Dremio Microsoft Dataverse Connector — Installer
#
...
banner() {
  ...
  echo -e "${BOLD}${CYAN}   Dremio Microsoft Dataverse Connector Installer${RESET}"
  echo -e "${BOLD}${CYAN}════════════════════════════════════════════════════${RESET}"
  echo ""
}
...
echo ""
echo -e "  Next: open Dremio → ${BOLD}Add Source${RESET} → ${BOLD}Microsoft Dataverse${RESET}"
echo ""
echo -e "  Or create a source from the command line:"
echo -e "    ${CYAN}ORG_URL=https://yourorg.api.crm.dynamics.com \\${RESET}"
echo -e "    ${CYAN}TENANT_ID=your-tenant-id \\${RESET}"
echo -e "    ${CYAN}CLIENT_ID=your-client-id \\${RESET}"
echo -e "    ${CYAN}CLIENT_SECRET=your-client-secret \\${RESET}"
echo -e "    ${CYAN}./add-dataverse-source.sh${RESET}"
echo ""
