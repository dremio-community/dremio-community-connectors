#!/usr/bin/env bash
# ============================================================================
# Dremio ServiceNow Connector — Installer
#
...
banner() {
  ...
  echo -e "${BOLD}${CYAN}   Dremio ServiceNow Connector Installer${RESET}"
  echo -e "${BOLD}${CYAN}════════════════════════════════════════════════════${RESET}"
  echo ""
}
...
echo ""
echo -e "  Next: open Dremio → ${BOLD}Add Source${RESET} → ${BOLD}ServiceNow${RESET}"
echo ""
echo -e "  Or create a source from the command line:"
echo -e "    ${CYAN}./add-servicenow-source.sh --name servicenow \\${RESET}"
echo -e "    ${CYAN}    --instance-url https://dev12345.service-now.com \\${RESET}"
echo -e "    ${CYAN}    --username admin --password secret${RESET}"
echo ""
