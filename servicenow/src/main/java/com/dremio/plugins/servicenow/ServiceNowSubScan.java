...
/**
 * Serializable unit of work for ServiceNow scan execution.
 */
@JsonTypeName("servicenow-sub-scan")
public class ServiceNowSubScan extends SubScanWithProjection {
    ...
    public ServiceNowScanSpec getScanSpec() { return scanSpec; }
    ...
    public PhysicalOperator getNewWithChildren(List<PhysicalOperator> children)
        ...
        return new ServiceNowSubScan(getProps(), getFullSchema(), getReferencedTables(),
