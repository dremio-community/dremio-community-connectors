...
/**
 * Physical plan node for a ServiceNow table scan.
 */
public class ServiceNowScanPrel extends ScanPrelBase implements OldScanPrelBase {

    private final ServiceNowGroupScan groupScan;
    private final ServiceNowScanSpec scanSpec;

    public ServiceNowScanPrel(
    ...
    public PhysicalOperator getPhysicalOperator(PhysicalPlanCreator creator) throws IOException {
        return new ServiceNowGroupScan(
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new ServiceNowScanPrel(getCluster(), traitSet, getTable(), getPluginId(),
    ...
    public ScanRelBase cloneWithProject(List<SchemaPath> columns) {
        return new ServiceNowScanPrel(getCluster(), getTraitSet(), getTable(), getPluginId(),
