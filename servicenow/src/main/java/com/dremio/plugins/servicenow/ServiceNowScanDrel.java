...
/**
 * Logical plan node for a ServiceNow table scan.
 */
public class ServiceNowScanDrel extends ScanRelBase implements Rel {

    private final ServiceNowScanSpec scanSpec;

    public ServiceNowScanDrel(
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new ServiceNowScanDrel(getCluster(), traitSet, getTable(), getPluginId(),
    ...
    public ScanRelBase cloneWithProject(List<SchemaPath> columns) {
        return new ServiceNowScanDrel(getCluster(), getTraitSet(), getTable(), getPluginId(),
