...
@JsonTypeName("prometheus-sub-scan")
public class PrometheusSubScan extends SubScanWithProjection {

    public static final int OPERATOR_TYPE = 5005;

    public static class PrometheusScanSpec {

        private final String tableName;
        private final long estimatedRowCount;

        @JsonCreator
        public PrometheusScanSpec(
        ...
        public String toString() {
            return "PrometheusScanSpec{table='" + tableName + "', rows=" + estimatedRowCount + '}';
        }
    }
    ...
    public PrometheusScanSpec getScanSpec() { return scanSpec; }
    ...
    public PhysicalOperator getNewWithChildren(List<PhysicalOperator> children)
        ...
        return new PrometheusSubScan(getProps(), getFullSchema(), getReferencedTables(),
