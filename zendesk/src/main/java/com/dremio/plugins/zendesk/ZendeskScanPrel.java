...
/**
 * Physical plan node for a Zendesk table scan.
 */
public class ZendeskScanPrel extends ScanPrelBase implements OldScanPrelBase {

    private final ZendeskGroupScan groupScan;
    private final ZendeskScanSpec scanSpec;

    public ZendeskScanPrel(
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new ZendeskScanPrel(getCluster(), traitSet, getTable(), getPluginId(),
    ...
    public ScanRelBase cloneWithProject(List<SchemaPath> columns) {
        return new ZendeskScanPrel(getCluster(), getTraitSet(), getTable(), getPluginId(),
