...
/**
 * Describes a Zendesk table scan.
 *
 * <p>Unlike Salesforce, Zendesk does not support OFFSET-based splits, so each
 * table is read as a single logical scan that pages through the full cursor chain.
 */
public class ZendeskScanSpec {
    ...
    public String toString() {
        return "ZendeskScanSpec{tableName='" + tableName + "', estimatedRowCount=" + estimatedRowCount + '}';
    }
}
