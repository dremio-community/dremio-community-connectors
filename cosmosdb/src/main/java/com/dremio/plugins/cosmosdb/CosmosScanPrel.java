...
public class CosmosScanPrel extends ScanPrelBase implements OldScanPrelBase {

    private final CosmosGroupScan groupScan;
    private final CosmosScanSpec scanSpec;

    public CosmosScanPrel(RelOptCluster cluster, RelTraitSet traitSet, RelOptTable table,
            StoragePluginId pluginId, TableMetadata tableMetadata,
            List<SchemaPath> projectedColumns, double observedRowcountAdjustment,
            List<RelHint> hints, CosmosGroupScan groupScan, CosmosScanSpec scanSpec) {
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new CosmosScanPrel(getCluster(), traitSet, getTable(), getPluginId(),
    ...
    public ScanRelBase cloneWithProject(List<SchemaPath> columns) {
        return new CosmosScanPrel(getCluster(), getTraitSet(), getTable(), getPluginId(),
