...
public class CosmosGroupScan extends AbstractGroupScan {

    private final StoragePluginId pluginId;
    private final CosmosScanSpec scanSpec;

    public CosmosGroupScan(
            OpProps props,
            TableMetadata tableMetadata,
            List<SchemaPath> columns,
            StoragePluginId pluginId,
            CosmosScanSpec scanSpec) {
    ...
    public SubScan getSpecificScan(List<SplitWork> work) throws ExecutionSetupException {
        return new CosmosSubScan(
                getProps(),
                getFullSchema(),
                List.of(List.of(scanSpec.getContainerName())),
                getColumns(),
                pluginId,
                scanSpec);
    }
    ...
    @JsonIgnore public CosmosScanSpec getScanSpec() { return scanSpec; }
}
