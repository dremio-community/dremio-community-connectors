...
public class CosmosRulesFactory extends StoragePluginTypeRulesFactory {
    ...
    public Set<RelOptRule> getRules(OptimizerRulesContext context,
        ...
        switch (phase) {
            case LOGICAL:
                return ImmutableSet.of(CosmosScanRule.INSTANCE);
            case PHYSICAL:
                return ImmutableSet.of(CosmosScanPrule.INSTANCE);
            default:
