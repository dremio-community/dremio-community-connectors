...
@JsonTypeName("cosmos-sub-scan")
public class CosmosSubScan extends SubScanWithProjection {

    private final StoragePluginId pluginId;
    private final CosmosScanSpec scanSpec;

    @JsonCreator
    public CosmosSubScan(
            @JsonProperty("props")     OpProps                  props,
            @JsonProperty("schema")    BatchSchema              schema,
            @JsonProperty("tables")    Collection<List<String>> tables,
            @JsonProperty("columns")   List<SchemaPath>         columns,
            @JsonProperty("pluginId")  StoragePluginId          pluginId,
            @JsonProperty("scanSpec")  CosmosScanSpec           scanSpec) {
    ...
    public PhysicalOperator getNewWithChildren(List<PhysicalOperator> children)
        ...
        return new CosmosSubScan(getProps(), getFullSchema(), getReferencedTables(),
