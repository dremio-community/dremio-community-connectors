#!/usr/bin/env bash
# ============================================================================
# Dremio Azure Cosmos DB Connector — Installer
#
...
banner() {
  ...
  echo -e "${BOLD}${CYAN}   Dremio Azure Cosmos DB Connector Installer${RESET}"
  echo -e "${BOLD}${CYAN}════════════════════════════════════════════════════${RESET}"
  echo ""
}
...
echo ""
echo -e "  Next: open Dremio → ${BOLD}Add Source${RESET} → ${BOLD}Azure Cosmos DB${RESET}"
echo ""
echo -e "  Or create a source from the command line:"
echo -e "    ${CYAN}./add-cosmosdb-source.sh --name cosmosdb \\${RESET}"
echo -e "    ${CYAN}    --endpoint https://myaccount.documents.azure.com:443 \\${RESET}"
echo -e "    ${CYAN}    --database mydb --master-key YOUR_KEY==${RESET}"
echo ""
